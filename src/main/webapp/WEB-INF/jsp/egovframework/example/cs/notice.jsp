				...
				<c:otherwise>
					<c:forEach var="item" items="${list}">
						<article class="notice-row new">
							...
							<a href="#n_${item.idx}"><c:out value="${item.title}" /></a>
							<time>
...
<section class="cta">
	<div class="container">
		...
		<p>Diversify your portfolio with precious metals trading and
			benefit from safe-haven assets during market volatility.</p>
		<a class="btn btn-light" href="${ctx}/${siteLang}/account-types">Open
			Live Account</a><a class="btn"
			style="background: rgba(255, 255, 255, .2); color: #fff" href="#">Try
			free demo</a>
	</div>
</section>
</main>
